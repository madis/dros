...
set :application, 'dros'
set :repo_url, 'git@github.com:madis/dros.git'
server 'mothermania', user: 'deployer', roles: %w(app db web)
...
set :slackistrano, channel: '#ops', webhook: ENV['SLACK_OPS_WEBHOOK_URL']
